...
<div class="container">
    ...
    <div class="contents" id="contents">
        <div class="breadcrumb">
            <p><a href="/">HOME</a> &gt; <a href="/qna/qnaList.jsp">자주하는 질문</a> &gt; <span>온라인 상담</span></p>
        </div>
            ...
            <div class="page_wrap">
                ...
                <form action="/faq/onlinePro.jsp" method="post">
                    <table class="tb1">
                        <tbody>
                        <tr>
                            <th><label for="name">작성자 ID</label></th>
                            <td>
                                <input type="text" name="name" id="name" class="indata">
                                <input type="hidden" name="author" id="author" value="<%=sid%>" class="indata">
                            </td>
                        </tr>
                        <tr>
                            <th><label for="from">보내는 사람<br>이메일 주소</label></th>
                            <td><input type="text" name="email" id="from" class="indata" required></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><textarea name="content" id="content" class="indata2" cols="80" rows="10" maxlength="990"></textarea></td>
                        </tr>
                        <tr>
                            <td colspan="2">
